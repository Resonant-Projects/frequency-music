...
_Comprehensive overview of mathematical foundations, tuning systems, tools, and composition approaches_
...
_Reference v1.0 — Data from microtuning-sources.json_
