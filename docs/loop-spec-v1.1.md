...
A hypothesis must specify _what we’re testing_, and the recipe specifies _how we express it musically_. This keeps experiments comparable over time.
...
- **EvidenceType:**peer_reviewed | preprint | popular | anecdotal | personal_inference | metaphysical_unsourced
- **Actionability:**directly_composable | indirectly_composable | inspirational_only
