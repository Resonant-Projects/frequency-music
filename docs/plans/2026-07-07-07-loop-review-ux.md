...
- [ ] **Step 1:** Harness tests: amended payload promotes with edited provenance; invalid amendment rejected; kind mismatch rejected; legacy no-amendment approve unchanged. Implement; codegen; commit.
