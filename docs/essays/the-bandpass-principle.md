...
_What a system can hear is determined before interpretation begins. Every ear, model, plugin, and analysis pipeline starts by deciding which bands exist — and whatever falls outside those bands becomes invisible, uncanny, or musically wasted._
