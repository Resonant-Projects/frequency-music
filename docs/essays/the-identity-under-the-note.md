# The Identity Under the Note

_A pitch is not a source. A transcript is not a voice. A caption is not an acoustic scene. The recent extraction batch keeps returning to the same hidden layer: the part of sound that proves what made it._
