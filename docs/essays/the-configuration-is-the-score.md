# The Configuration Is the Score

_Before you write a note, you choose a geometry. The Tonnetz, the room, the mixing console, the arousal model — each one is a configuration that determines which musical relationships can exist. The configuration doesn't describe the music. It is the music's possibility space._
