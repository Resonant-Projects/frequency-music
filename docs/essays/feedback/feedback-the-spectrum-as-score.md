...
> "If we can isolate the latent dimensions that control *how* the null space is filled, we can build instruments that allow composers to navigate that space explicitly..."
