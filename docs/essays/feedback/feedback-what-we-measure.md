...
The "Listener as Transfer Function" section is fascinating. Using BiFormer3D (HRIRs) to argue that physical anatomy filters sound _before_ cultural perception does is a strong physical grounding for subjective experience.
