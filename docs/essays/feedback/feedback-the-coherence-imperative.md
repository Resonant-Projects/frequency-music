...
"The Fourier transform decomposes a signal into independent sinusoidal components. This is mathematically exact and invertible. But the independence is a property of the _representation_, not the _signal_." This is a spectacular piece of explanatory writing. It cuts right to the heart of the epistemology of signal processing.
