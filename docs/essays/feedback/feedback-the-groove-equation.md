...
The mathematical explanation in the "Sierpinski Rhythm" section is extremely dense and requires unpackaging. Stating that "the bitwise AND of _n_ and _k_ equals _k_, by Lucas's theorem" is a massive cognitive leap for a reader. You need to walk through _one concrete example_ (e.g., n=4, k=2) to prove the math works before declaring it a universal compositional tool.
...
> "What's mathematically interesting here is that the analog processing chain introduces _micro-timing perturbations_... These perturbations function as a form of _controlled asymmetry_ analogous to the polska's non-isochronous beats."
