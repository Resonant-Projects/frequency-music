...
Some of these claims are testable. Some have been tested. The results are more interesting than either believers or skeptics tend to acknowledge.
...
Against that ancient backdrop, consider Akimoto et al. (2018), published in a peer-reviewed journal. Nine healthy adults listened to five minutes of piano music — the same piece, performed once in standard 440 Hz tuning and once retuned so that A4 = 444 Hz (placing 528 Hz on a scale degree). Crossover design: each participant experienced both conditions.

The results were surprisingly asymmetric:

- **Cortisol** dropped significantly after 528 Hz exposure (0.43 → 0.25 μg/dL, p < 0.011) but showed no significant change after 440 Hz
- **Oxytocin** nearly doubled after 528 Hz (37.57 → 73.58 pg/mL, p < 0.038) with only a non-significant increase after 440 Hz
- **Tension-anxiety** decreased significantly after 528 Hz (p < 0.009) but not after 440 Hz
- **Heart rate variability** (LF/HF ratio) decreased after both — suggesting both conditions reduced sympathetic activation — but only 528 Hz additionally reduced CVRR, a parasympathetic regulation marker
...
The study has n = 9. That's not a typo. Nine participants. In biomarker research where individual variation is enormous, this is barely a pilot study. The p-values look impressive but are fragile — a single outlier could shift any of them past significance.

More fundamentally: the frequency difference between A4 = 440 Hz and A4 = 444 Hz is approximately 15.7 cents — less than a sixth of a semitone. The entire piece is shifted by this amount. Every note, not just the ones landing on 528 Hz, is ~1% higher. Is the auditory system — or the endocrine system — really sensitive to a uniform 1% pitch shift across all frequencies?

Maybe. But the study doesn't isolate 528 Hz as a specific frequency. It compares two global tuning systems. The "528 Hz" label is a metonym for "everything slightly sharper." A more precise description would be: "A4=444 Hz tuning produced different physiological responses than A4=440 Hz tuning." Whether 528 Hz specifically is doing anything remains an open question.

The study also didn't independently measure perceived pleasantness. If the 444 Hz version simply sounded better to these nine people — brighter, more resonant in that particular piano's overtone structure — the entire effect could be aesthetic preference driving physiology, with frequency as a confound rather than a cause.
...
Here's where the physics becomes suggestive rather than conclusive.

A forced harmonic oscillator — one of the most studied systems in physics — responds dramatically differently to different driving frequencies. Near the natural frequency, amplitude spikes. The Laplace transform analysis of such systems reveals that the locations of poles in the complex s-plane determine whether the system rings, decays, or blows up. This is freshman physics, completely uncontroversial.
...
1. **Music affects physiology.** Dozens of well-powered studies confirm this. Music modulates cortisol, heart rate variability, immune markers, pain perception, and neural synchronization.

2. **Frequency-specific effects exist in simple physical systems.** Resonance, mode shapes, and preferential coupling are established physics.

3. **Frequency-specific biological effects are plausible but poorly characterized.** The Akimoto study is suggestive but wildly underpowered. We don't have a reliable map from input frequency to biological response.

4. **Most specific frequency claims (528 Hz = DNA repair, 432 Hz = natural tuning, 396 Hz = liberation from fear) have no scientific basis.** The solfeggio frequency system was derived from numerological operations on biblical verse numbers, not from any acoustic or biological measurement.
...
Until then, the honest position is uncertainty. Not the comfortable uncertainty of "probably nothing." The uncomfortable uncertainty of "maybe something, but we don't know what."
