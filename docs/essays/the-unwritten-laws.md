...
Genres are not primarily sonic categories. They are **ethical frameworks** — systems of values about what constitutes authenticity, virtuosity, honesty, and craft. The same musical act can be heroic under one genre's laws and criminal under another's. Understanding this reframes genre not as a marketing taxonomy but as a moral philosophy of sound.

## Rock Law vs. Jazz Law
...
Lau Noah, the Catalan guitarist whose harmonic vocabulary bewildered even Neely, offers a different angle on the same insight. In their conversation about her approach to harmony ("The Harmonic Genius of Lau Noah," 2025), she describes discovering chords through physical gesture on the guitar — shapes that feel right to her hands before they have names. When Neely, the trained theorist, starts labeling what she's playing, she pushes back: **"Naming something forces a perspective on it."**

This is not anti-intellectual obscurantism. It's a precise epistemological claim. The moment you call a chord "a Cmaj7♯11," you've imported the entire framework of jazz harmony — its assumptions about function, voice leading, resolution. You've placed the chord under jazz law. But Noah didn't find that chord through jazz law. She found it through what Neely calls "kinesthetic composition" — the physical logic of fingers on fretboard, the guitar's geometry suggesting harmonic possibilities that no theory would predict but that sound undeniably right.

Her stated goal — "to find a way to play a million chords and make it sound like it's four" — is itself a genre statement. It declares a value system: complexity should serve simplicity. The listener's experience of naturalness is the highest court of appeal. This is neither rock law nor jazz law. It's something closer to **folk law**: the music should feel like it always existed, even if it took extraordinary craft to create.

## The Beatles Paradox

The Beatles sit at the exact fault line where these legal systems collide. David Bennett's analysis of "Happiness Is A Warm Gun" (the Beatles' "most complex song") reveals a piece that stitches together at least three distinct sections — "The Dirty Old Man," "The Junkie," "The Gunman" — each with different meters, feels, and harmonic languages. The time signatures shift under your feet. Ringo maintains a 4/4 kick-snare pattern as an anchor while the rest of the band moves through 3/4, creating a metric counterpoint that is, by any analytical standard, genuinely sophisticated.
...
## Genre as Moral Philosophy

If we take this framework seriously, several things follow:

**1. Genre debates are really ethics debates.** When people argue about whether something "counts" as jazz, or whether an electronic producer is a "real" musician, they're not arguing about sound. They're arguing about which ethical framework should apply. The sound is evidence; the verdict is moral.

**2. Musical innovation often means founding a new court.** The Beatles didn't just make new sounds — they created a new set of laws under which music could be judged. So did hip-hop (where sampling and flow constitute their own authenticity framework, with its own deep referentiality and historical awareness). So did electronic music (where the producer's vision and sonic architecture replace the performer's embodied skill as the locus of authorship).
...
- **"Finding One"**: Frame choice in meter ↔ jurisdictional choice in genre ethics
- **"The Representation Gap"**: How you encode music determines what you can say about it ↔ which genre law you apply determines what counts as virtue
- **"Counting the Cubes"**: Quotient structures in enumeration ↔ quotient structures in value systems
- **"The Polyphony Problem"**: Simultaneous independent voices ↔ simultaneous applicable genre laws
- **"The Surface and the Source"**: Surface features (sound) vs. source processes (craft, intention) ↔ the evidence/verdict distinction in genre law
