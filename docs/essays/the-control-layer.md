...
_The note is not the whole message. Across synthesis practice, speech modeling, watermarking, compression, and bioacoustics, the same hidden layer keeps reappearing: slow modulation, timing, phase, silence, and envelope shape often decide what a sound means before pitch or timbre can be interpreted._
