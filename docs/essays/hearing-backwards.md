...
This is remarkable and deserves emphasis: **the sound contains more information about the vocal tract than a direct image of it.** The articulatory contour representation works better than raw MRI pixels because it discards redundant spatial information while preserving the dynamics of shape change. The body's geometry is more legible in its acoustic shadow than in its photograph.
