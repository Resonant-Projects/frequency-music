# The Dominant Channel: Why Structure Suppresses Signal

*Essay #64 — March 23, 2026*
...
The DEAF authors identify two distinct failure modes: *content-driven bias* (where the semantic content of transcribed text overrides acoustic cues) and *prompt-induced sycophancy* (where the model follows the textual framing of a question rather than listening to the audio). Both stem from the same root: the text channel has more structure, so the model leans on it.
...
*Connects to: The Informative Noise (#63), The Orthogonal Unknown (#61), The Periodic Signature (#62), The Borrowed Structure (#60)*
