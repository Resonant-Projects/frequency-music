...
crons.interval("poll-feeds", { hours: 6 }, internal.ingest.pollAllFeedsInternal);
...
crons.interval("batch-extract", { hours: 8 }, internal.workflows.startBatchExtractionInternal, {
  limit: 3,
});
