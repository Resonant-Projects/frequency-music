...
excerpt: "Source identity in audio is effective, not absolute—a source exists physically only if listeners or machines can extract stable evidence of it, collapsing the gap between metaphysical causes and…"
