...
excerpt: "Musical identity is carried by load-bearing layers—listeners track specific features while ignoring others, and transformation fails when it damages the layer the piece depends on, not when it…"
