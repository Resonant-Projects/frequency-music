---
title: "Geometric Microtuning: From Sacred Geometry to Composition"
publishDate: 2026-02-18
excerpt: "Bridge Grant's geometric correspondence between musical intervals and polygons with practical microtuning systems, deriving a coherent temperament based on 432Hz tuning for composition."
...
This essay bridges Robert Edward Grant's research on the geometric correspondence between musical intervals and polygonal shapes with practical microtuning systems and composition techniques. We derive a "Geometric Temperament" based on Grant's 432Hz findings, explore its mathematical foundations, and provide concrete guidance for composing with it.

---

## Part 1: Grant's Geometric Music Theory
...
This creates intervals that align with geometric proportions while maintaining practical playability.

---

## Part 2: Mathematical Framework

### Converting Geometry to Cents

To translate Grant's angles to a tuning system, we use the relationship:

```
cents = (angle / 360) × 1200
```
...
### The Geometric Scale (derived from Grant)
...
**Proposed Geometric 12-Note Scale (in cents from C):**
...
D:    200     (triangle - 60°)
Eb:   300     (square - 90°)
E:    386.31  (pure 5:4 major 3rd)
F:    498     (pure 4:3 fourth)
F#:   600     (geometric center)
G:    702     (pure 3:2 fifth)
Ab:   800     (square complement)
A:    884.36  (pure 5:3 major 6th)
Bb:   1000    (decagon - 144°)
B:    1088.27 (pure 15:8 major 7th)
C':   1200
```

---

## Part 3: Compositional Application

### Chord Construction in Geometric Temperament
...
```
Pattern: C → D → Eb → F → G → Ab...
Cents:   0   200  300  500  700  800...
```
...
### Creating the Scale in Scala Format

```scala
! geometric-temperament.scl
!
Geometric Temperament based on Grant's polygon-angle theory
 12
!
 100.89
 200.00
...
1. **Tuning Reference**: Set master pitch to A=432Hz
2. **Load Scale**: Import .scl file into MTS-ESP or synth
3. **Tempo**: Use 108 BPM (or multiples/divisions)
4. **Time Signature**: Start with 4/4, experiment with 3/4 and 5/4

### Composition Workflow

1. **Foundation**: Build drone/bass on geometric root (C=256Hz)
2. **Harmonic Frame**: Use pure 5ths (702¢) for stability
3. **Color Intervals**: Add polygon-derived intervals for character
4. **Melodic Development**: Use triangle/square patterns
5. **Rhythmic Layer**: Match time signature to melodic geometry

---

## Part 5: Example Composition Sketch
...
- Builds to climax on pure C major

**Coda**: Return to drone, tempo halves to 54 BPM

---

## Conclusion

Robert Edward Grant's geometric music theory provides a framework for understanding tuning as spatial relationship. By translating polygon angles to cents and applying geometric principles to rhythm and tempo, we create a coherent system where pitch, time, and structure reflect the same underlying mathematics.
