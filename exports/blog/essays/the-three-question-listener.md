...
excerpt: "A three-part framework for machine listening—identity, event, and time—offers composers a way to analyze overlapping sound without collapsing polyphony into a single answer."
