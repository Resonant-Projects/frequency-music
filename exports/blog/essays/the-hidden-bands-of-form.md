...
excerpt: "Multi-band decomposition, semantic planning, phase watermarking, Tonnetz geometry, metastable ice paths, and call-and-response production suggest that musical identity can be distributed across…"
