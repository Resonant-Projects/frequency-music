...
excerpt: "Wavelet scattering, Bark bands, phase-equivariant music embeddings, encoder failures, Tonnetz paths, and metastable ice phases all point to the same compositional principle: fine structure decides…"
