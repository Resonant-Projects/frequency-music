...
excerpt: "Sound encodes the geometry of its physical source—rooms, bodies, authenticity—and these geometric structures can be recovered from audio alone. Three recent papers reveal how the inverse problem of hearing backwards unlocks compositional implications."
