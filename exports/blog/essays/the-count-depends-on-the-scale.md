...
excerpt: "How we count sound sources depends on listening scale and task: a cymbal wash is one texture to a mixer, many partials to a model, one gesture to a drummer."
