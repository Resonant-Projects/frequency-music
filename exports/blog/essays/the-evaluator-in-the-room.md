...
excerpt: "Evaluation shapes music through measurement systems—from ASR verifiers to human ears. Compose not just the signal, but the evaluator's environment and its inherited listening habits."
