...
excerpt: "A musical representation is useful when its coordinates preserve the actions a musician needs—from latent spaces to ragas to vocal timing, the basis determines what can be controlled."
