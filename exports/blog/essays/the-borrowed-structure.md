...
excerpt: "Text-to-audio diffusion models can reuse structural components from similar sounds, achieving 1.8-3.0× speedup while improving quality-revealing that all sounds cluster around ~1,000 acoustic…"
