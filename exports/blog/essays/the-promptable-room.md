...
excerpt: "Generative models can now create room impulse responses from natural-language descriptions, transforming acoustic space from a measured artifact into a compositional parameter that lives between…"
