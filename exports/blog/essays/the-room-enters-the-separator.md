...
excerpt: "Source separation isn't just isolating sound sources—it's negotiating the boundary between event and medium, deciding which transfer functions belong to the source versus the room."
