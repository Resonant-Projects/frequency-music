...
Generated at: 2026-02-23T03:10:46.376Z
...
- Prior runs scanned: 4
- Prior source IDs tracked: 14
- Prior topic tokens tracked: 169
...
- circadian rhythms: 1
- spontaneous production rate: 1
- tempo perception: 1
- personalized music: 1
- midi keyboard mapping: 1
- equal division of octave (edo): 1
- scale degrees: 1
- keyboard ergonomics: 1
- scala software: 1
- moment of symmetry scales: 1
- xenharmonic music: 1
- tuning file formats: 1
- scala: 1
- keyboard mapping: 1
- midi: 1
- tutorial: 1
- prime number patterns: 1
- geometric distributions: 1
- digital root analysis: 1
- 24-sided polygon (icositetragon): 1
- fibonacci sequences: 1
- mathematical harmonics: 1
- quasicrystal patterns: 1
- fractal symmetry: 1
- ramanujan tau function: 1
- prime numbers: 1
- quasi-primes: 1
- digital roots: 1
- 24-sided polygon: 1
- quartertone tuning: 1
- ancient pyramid geometry: 1
- musical intervals: 1
- 432 hz tuning: 1
- 528 hz frequency: 1
- pentatonic scales: 1
...
- giza plateau: 1
- musical archaeology: 1
- quartertones: 1
- pyramids: 1
- 24 notes: 1
- ancient geometry: 1
- geometric spirals: 1
- right triangle mathematics: 1
- natural pattern formation: 1
- hurricane categorization: 1
- galactic spiral arms: 1
- golden ratio alternatives: 1
- polygonal geometry: 1
- mathematical modeling of nature: 1
...
### S2 — Four McGill studies make Québec Science’s list of the Top 10 Discoveries of the Year

- Source ID: jx7amg6kghtxzdkxxa8d5nhzr181cd28
- Extraction ID: j9790ybkvrm64d8vzdzm3h4bn981cbnz
- Type: rss
- Status: extracted
- URL: https://brams.org/2026/01/19/four-mcgill-studies-make-quebec-sciences-list-of-the-top-10-discoveries-of-the-year/
- Scores: base=26.00, normalized=0.241, intraNovelty=1.000, crossRunNovelty=0.967, combined=0.648
- Reuse penalties: source=0.00, topic=0.11
- Topics: music therapy, pain management, hypoalgesia, neural oscillations, circadian rhythms, spontaneous production rate, tempo perception, personalized music, auto-ingested
...
- What are the specific neural frequencies associated with pain that music can influence?
- How long does the pain relief effect last with tempo-matched music?
- Can this approach be combined with other pain management techniques for enhanced effect?

### S3 — Mapping microtonal scales to a MIDI keyboard in Scala

- Source ID: jx71ddzhtdz23f72fw2yh0m4z181d0sa
- Extraction ID: j978hgsy4b6xemvy5ekqsbbar981d3er
- Type: url
- Status: extracted
- URL: https://sevish.com/2017/mapping-microtonal-scales-keyboard-scala/
- Author: Sevish
- Scores: base=27.00, normalized=0.253, intraNovelty=0.935, crossRunNovelty=0.957, combined=0.635
- Reuse penalties: source=0.00, topic=0.14
- Topics: microtonal music, midi keyboard mapping, equal division of octave (edo), scale degrees, keyboard ergonomics, meantone temperament, scala software, moment of symmetry scales, xenharmonic music, tuning file formats, scala, keyboard mapping, midi, tutorial
...
- What ergonomic considerations should guide microtonal keyboard mapping design?
- How do performers adapt their muscle memory when switching between different microtonal keyboard mappings?

### S4 — Accurate and Infinite Prime Prediction from Novel Quasi-Prime Analytical Methodology

- Source ID: jx7ee6pxqhhxg7fwwh9eyjfgen81c348
- Extraction ID: j9722xab53c1wsvcadtsq0hgjh81dgf4
- Type: pdf
- Status: extracted
- URL: https://arxiv.org/abs/1903.08570
- Scores: base=21.00, normalized=0.177, intraNovelty=1.000, crossRunNovelty=1.000, combined=0.630
- Reuse penalties: source=0.00, topic=0.00
- Topics: prime number patterns, geometric distributions, digital root analysis, 24-sided polygon (icositetragon), fibonacci sequences, mathematical harmonics, quasicrystal patterns, fractal symmetry, ramanujan tau function, prime numbers, quasi-primes, digital roots, 24-sided polygon
...
- Do the geometric prime distributions have any connection to harmonic series or musical intervals?
- Could digital root analysis techniques be applied to analyze musical sequences or frequency patterns?

### S5 — NEW DISCOVERY: The 24 Note Quartertone Relationship to Ancient Pyramids

- Source ID: jx70pej233h2qc133kmqxaqyms81d6v7
- Extraction ID: j97b7vv0p7awywtjhz4ay37y0181cwgn
- Type: url
- Status: extracted
- URL: https://robertedwardgrant.com/new-discovery-the-24-note-quartertone-relationship-to-ancient-pyramids/
- Scores: base=23.00, normalized=0.203, intraNovelty=1.000, crossRunNovelty=0.957, combined=0.628
- Reuse penalties: source=0.00, topic=0.14
- Topics: quartertone tuning, ancient pyramid geometry, musical intervals, 432 hz tuning, 528 hz frequency, pentatonic scales, sacred geometry, temperament systems, giza plateau, musical archaeology, quartertones, pyramids, 24 notes, ancient geometry
...
- harmonicProfile: 11/9 interval (Divine Major 2.5th)
...
- What evidence exists for intentional musical/acoustic design in ancient pyramid construction?
- Can the claimed frequency values (432.081 Hz, 528.099 Hz) be independently verified through pyramid measurements?

### S6 — A Novel Geometric Model of Natural Spirals Based on Right Triangle Polygonal Modular Formations

- Source ID: jx77mx2zsz4ypg8qwnp7th3t8581cg4a
- Extraction ID: j97amfrpacd0w9n91yk9m7v93981d02e
- Type: pdf
- Status: extracted
- URL: https://arxiv.org/abs/2111.02895
- Scores: base=20.00, normalized=0.165, intraNovelty=1.000, crossRunNovelty=1.000, combined=0.624
- Reuse penalties: source=0.00, topic=0.00
- Topics: geometric spirals, right triangle mathematics, natural pattern formation, hurricane categorization, galactic spiral arms, golden ratio alternatives, polygonal geometry, mathematical modeling of nature, fractal structures, harmonic ratios, spirals, fractals, right triangles, nature patterns
...
- What is the relationship between these geometric ratios and musical tuning systems?
- Could natural spiral formations influence acoustic properties of environments (shells as resonators, etc.)?
- How might the mathematical relationships discovered here apply to sound wave propagation patterns?

### S7 — Grinning During Sex Isn’t Contagious, But It Does Require Tempo

- Source ID: jx78t2a7b07ssg7yad9mm3jpgd81hgpb
- Extraction ID: j973h3w2wmjhbxs5hph8gz926d81gnfp
- Type: rss
- Status: extracted
- URL: https://nautil.us/grinning-during-sex-isnt-contagious-but-it-does-require-tempo-1269012/
- Scores: base=24.00, normalized=0.215, intraNovelty=0.941, crossRunNovelty=0.967, combined=0.622
- Reuse penalties: source=0.00, topic=0.11
- Topics: rhythm, tempo, biological rhythms, evolutionary musicology, communication, behavioral tempo, primate behavior, movement frequency, auto-ingested
